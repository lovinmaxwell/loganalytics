                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="user-body">
                        ...
                        <div class="col-xs-3 text-center">
                            <a href="{{ url('/modules/users') }}"><i class="fa fa-btn fa-user"></i> Users</a>
                        </div>
                        @endcan
                        @can('access roles')
                            <div class="col-xs-3 text-center">
                                <a href="{{ url('/modules/roles') }}"><i class="fa fa-btn fa-certificate"></i> Roles</a>
                            </div>
                        @endcan
                        @can('access permissions')
                            <div class="col-xs-3 text-center">
                                <a href="#"><i class="fa fa-key"></i> Access</a>
                            </div>
                        @endcan
